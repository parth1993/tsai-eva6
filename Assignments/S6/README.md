...
![formula](https://render.githubusercontent.com/render/math?math=\Large%20(i)%20%20%20%20\mu_{\mathcal{B}}%20\leftarrow%20\frac{1}{m}%20\sum_{i=1}^{m}%20x_{i})
...
![formula](https://render.githubusercontent.com/render/math?math=\Large%20(ii)%20%20%20%20\sigma_{\mathcal{B}}^{2}%20\leftarrow%20\frac{1}{m}%20\sum_{i=1}^{m}\left(x_{i}-\mu_{\mathcal{B}}\right)^{2})
